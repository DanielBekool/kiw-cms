...
<!--Footer-->
<footer id="footer" class="lg:pt-30 pt-18 bg-cover bg-[var(--color-transit)]" style="background-image:url('{{ asset('storage/media/Footer.jpg') }}')">
    <div class="flex flex-col overflow-hidden relative lg:gap-20 sm:gap-10 gap-10 lg:max-w-[1200px] mx-auto lg:px-0 sm:px-6 px-4">
        ...
        <div>
            ...
            <div class="flex flex-row sm:gap-5 gap-8 sm:w-1/6">
                    <img class="sm:w-full w-24" src="{{ asset('storage/media/kiwinners.png') }}" alt="kiwinners">
                    <img class="sm:w-full w-24" src="{{ asset('storage/media/akhlak.png') }}" alt="akhlak">
                    <img class="sm:w-full w-24" src="{{ asset('storage/media/bumn-untuk-indonesia.png') }}" alt="bumn">
                </div>
