...
<!--Start About-->
<section id="about" class="bg-contain bg-no-repeat bg-bottom sm:bg-cover" style="background-image:url({{ asset('storage/media/about-image.jpg') }})">
...
<!--Start Perjalanan-->
<section id="perjalanan" class="relative flex flex-col gap-18 px-4 sm:px-6 py-18 sm:pt-30 lg:pt-40 lg:pb-0 bg-cover bg-no-repeat" style="background-image:url('{{ asset('storage/media/bg-perjalanan.jpg') }}')">
    ...
    <div class="flex flex-col sm:flex-row-reverse justify-between sm:items-center gap-9 lg:w-[1200px] lg:mx-auto">
        ...
        <!--Image-->
        <img class="rounded-2xl lg:rounded-b-none sm:w-[45%] lg:w-[35%] sm:h-[450px] lg:h-[460px] sm:object-cover" src="{{ asset('storage/media/perjalanan-image.jpg') }}" alt="perjalanan">
    </div>
...
<section id="tab" class="my-18 lg:my-30 px-4 sm:px-6 lg:px-0 lg:w-[1200px] lg:mx-auto relative">
    <div x-data="{ tab: 'tab1' }" class="rounded-md">
        ...
        <x-tab.tab-contents-saham id="tab2">
            <div class="flex flex-col lg:flex-row lg:justify-between gap-12">
                <div class="flex flex-col justify-between gap-10 lg:gap-20 lg:w-1/2">
                    <img class="w-1/4 sm:w-1/5 lg:w-1/3" src="{{ asset('storage/media/gbc-logo.png') }}" alt="PWS">
                    <div class="flex flex-col gap-5">
                ...
                <div class="relative lg:w-1/2">
                    <a href="{{ asset('storage/media/anak-perusahaan-1.png') }}" data-lightbox="gallery">
                        <img class="w-full object-contain" src="{{ asset('storage/media/anak-perusahaan-1.png') }}">
                    </a>
                </div>
            </div>
        </x-tab.tab-contents-saham>
        ...
        <x-tab.tab-contents-saham id="tab3">
            <div class="flex flex-col lg:flex-row lg:justify-between gap-12">
                <div class="flex flex-col justify-between gap-10 lg:gap-20 lg:w-1/2">
                    <img class="w-1/4 sm:w-1/5 lg:w-1/3" src="{{ asset('storage/media/pws-logo.png') }}" alt="PWS">
                    <div class="flex flex-col gap-5">
                        <h6 class="bullet-1">anak perusahaan</h6>
                ...
                <div class="relative lg:w-1/2">
                    <a href="{{ asset('storage/media/anak-perusahaan-2.png') }}" data-lightbox="gallery">
                        <img class="w-full object-contain" src="{{ asset('storage/media/anak-perusahaan-2.png') }}">
                    </a>
                </div>
            </div>
        </x-tab.tab-contents-saham>
