...
<section id="about-pengadaan" class="relative bg-contain bg-no-repeat bg-bottom z-10" style="background-image:url({{ asset('storage/media/pengadaan-content.jpg') }})">
...
<section data-aos="fade-up" id="peringatan" class="relative sm:px-6 lg:px-0 sm:-mt-20 lg:-mt-25 lg:w-[1200px] lg:mx-auto z-20">
    <div class="bg-cover px-4 sm:px-6 pt-18 sm:pt-0 lg:px-10 flex flex-col sm:rounded-lg justify-between sm:flex-row gap-8" style="background-image:url('{{ asset('storage/media/gradient-pengadaan.jpg') }}')">
        ...
        <img class="object-contain sm:w-1/3 lg:w-1/2 sm:self-end sm:-ml-5 lg:-ml-0 lg:-mt-20" src="{{ asset('storage/media/bad-guy.png') }}">
    </div>
</section>
