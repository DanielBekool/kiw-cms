...
<x-layouts.app :title="$title ?? 'Default Page'" :body-classes="$bodyClasses">
    ...
    <div id="splash-screen">
        <div class="logo-sequence min-w-[100vw] min-h-[100vh] flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('storage/media/background-splash.jpg') }}');">
        <div class="absolute inset-0 bg-white opacity-90 !z-[99999999999999999999999991]"></div>
        
        <img id="logo-image" class="relative !z-[99999999999999999999999992] min-h-18 max-h-18  object-contain" src="{{ asset('storage/media/kiw-old.png') }}" alt="Logo">
        <div id="year-text" class="custom-shadow !z-[99999999999999999999999993] lg:text-[25em] sm:text-[20em] text-[10em] lg:py-0 py-4 font-bold text-transparent bg-cover bg-center bg-no-repeat bg-clip-text bg-fixed pointer-events-none lg:-mt-15 sm:-mt-25 -mt-16" style="background-image: url('{{ asset('storage/media/background-splash.jpg') }}');">
                1988
        </div>
    ...
    <div id="logo-sequence" class="hidden" >
        ...
        <img class="logo-item" data-year="2018" src="{{ asset('storage/media/pws-logo.png') }}" alt="Logo tahun 2018">
        <img class="logo-item" data-year="2020" src="{{ asset('storage/media/gbc-logo.png') }}" alt="Logo tahun 2020">
        <img class="logo-item" data-year="2022" src="{{ asset('storage/media/Danareksa.png') }}" alt="Logo tahun 2022">
        <img class="logo-item" data-year="2022" src="{{ asset('storage/media/Danareksa.png') }}" alt="Logo tahun 2022">
        <img class="logo-item" data-year="2024" src="{{ asset('storage/media/Danareksa.png') }}" alt="Logo tahun 2024">
                ...
                <div class="swiper-wrapper relative">
                    ...
                    <div class="swiper-slide relative overflow-hidden">
                        <div class="absolute inset-0 z-0">
                            <img id="video-fallback" src="{{ asset('storage/media/background-home.jpg') }}" alt="Banner Image" class="w-full h-full object-cover absolute inset-0 z-0" />
                                ...
                                <div class=" flex flex-col justify-between items-start lg:pt-13 sm:pb-2 lg:pb-7 pb-6 lg:h-[110vh] sm:h-[600px] h-[654px]">
                                    ...
                                    <div class="flex flex-col items-start gap-5 sm:p-6 p-4 lg:w-[1200px] lg:mx-auto lg:px-0 sm:pt-8 px-4 mt-40 z-20">
                                        ...
                                        <a class="w-fit btn2 mt-5" data-aos="fade-down" href="/#layanan-home">
                                            ...
                                            <img src="{{ asset('storage/media/arrow-right-solid.png') }}" alt="icon">
                                            </span>
                                        </a>
                                    </div>
                                    <!-- counter -->
                    ...
                    <!--Item Photo-->
                    <div class="swiper-slide relative bg-cover bg-no-repeat overflow-hidden" style="background-image:url('{{ asset('storage/media/hero-home-2.jpg') }}')">
        ...
        <section id="about-home" class="bg-[var(--color-transit)] lg:py-30 py-18">
            <div class="flex flex-col overflow-hidden relative lg:gap-0 sm:gap-10 gap-10  lg:px-0 lg:lg:max-w-[1200px] lg:mx-auto sm:px-6 px-4">
                ...
                <div class="flex lg:flex-row flex-col justify-between !gap-15 items-start lg:-mb-10">
                    ...
                    <!--image top right-->
                    <div class="lg;!w-[45%]">
                        <img class="rounded-2xl lg:!h-[550px] sm:!h-[450px] lg:!w-[unset] sm:!w-[100vw] object-cover" src="{{ asset('storage/media/construction-site-with-cranes-construction-worker.jpg') }}" alt="about">
                    </div>
                </div>
                ...
                <div class="flex sm:flex-row flex-col-reverse justify-start items-center gap-10">
                    ...
                    <div class="sm:w-[48%] w-[100%]">
                        <img class="rounded-2xl h-[340px] object-cover" src="{{ asset('storage/media/pointing-sketch.jpg') }}">
                    </div>
        ...
        <!-- Start Layanan Home -->
        <section id="layanan-home" class="lg:py-30 py-18 bg-cover " style="background-image: url('{{ asset('storage/media/bg-grad.jpg') }}');">
        ...
        <!--Start Keunggulan-->
        <section id="keunggulan-home" class="bg-no-repeat bg-cover" style="background-image: url('{{ asset('storage/media/back-keunggulan.jpg') }}')">
            <!--Overlay-->
