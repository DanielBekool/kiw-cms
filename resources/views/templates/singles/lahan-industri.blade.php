...
<section data-aos="zoom-in-up" id="lahan-industri" class="relative map-container my-18 lg:my-30 relative px-4 sm:px-6 lg:px-0 overflow-x-auto whitespace-nowrap max-w-full lg:w-[1200px] lg:mx-auto">
    <div class="relative inline-block min-w-full">
        <img src="{{ asset('storage/media/lahan-industri.jpg') }}" class="w-full">
